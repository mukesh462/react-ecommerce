...
function FilterPage() {
  ...
  return (
    <div>
      ...
      <div className=" mr-8 sm:block md:block lg:hidden xl:hidden"  variant="primary" onClick={handleShow}>
        ...
        <div className="flex justify-center items-center">
          ...
          <button className="ml-5 flex flex-row justify-center items-center ">
            ...
            />
            <span className="text-black font-bold hidden md:block lg:block xl:block">Search</span>
          </button>
        </div>
     ...
     <Modal
      ...
      >
        <Modal.Header >
          <Modal.Title className="flex justify-between w-full">Filter <XCircleIcon onClick={handleClose} className="h-8 text-black font-bold" /></Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <Container>
        ...
        <Modal.Footer>
          <button className="p-2 rounded-md bg-indigo-500 text-white" onClick={handleClose}>
           Apply filter
          </button>
      ...
      <div className="grid  sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3  rounded-lg border-t-2">
     
        <div className=" col-end-1 hidden sm:hidden md:hidden lg:block xl:block ">
